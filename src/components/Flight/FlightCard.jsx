...
const FlightCard = ({ flight }) => {
  return (
    <div class="p-10">
      <div class="max-w-full flex flex-col rounded overflow-hidden shadow-lg flight-card">
        ...
        <div class="mt-2 flex sm:flex-row mx-6 sm:justify-between flex-wrap">
          <div class="flex flex-row place-items-center p-2">
            ...
            <div class="flex flex-col ml-2">
              <p class="text-xs text-gray-500 font-bold">{flight.airline}</p>
          ...
          <div class="flex flex-col p-2">
            ...
            <p class="text-gray-500 font-bold">{flight.departure_airport}</p>
          </div>
          <div class="flex flex-col flex-wrap p-2">
            ...
            <p class="text-gray-500 font-bold">{flight.arrival_airport}</p>
          </div>
        </div>
        <p className="text-end mx-8">{flight.duration.substring(0, 5)} hours</p>
        <div class="mt-4">
          <div class="flex mx-6 py-4 flex-row flex-wrap items-center justify-between">
            <svg
              class="w-12 h-10 p-2 mx-2 self-center rounded-full fill-current text-white"
              viewBox="0 0 64 64"
              pointer-events="all"
              aria-hidden="true"
              role="presentation"
            ...
            <div class="text-sm mx-2 flex flex-col">
              ...
              <Link
                to={`/flight/${flight.id}`} state={{flight}}
              >
              {/*   */}
                <button class="font-medium w-32 h-11 rounded flex border-solid mx-2 justify-center place-items-center bg-green">
                  <div>See More</div>
                </button>
              </Link>
          </div>
